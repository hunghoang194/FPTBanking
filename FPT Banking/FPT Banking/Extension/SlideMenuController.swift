...
open class SlideMenuController: UIViewController, UIGestureRecognizerDelegate {
    ...
    open var rightClosePanGesture: UIPanGestureRecognizer?
    ...
    open override func viewWillTransition(to size: CGSize, with coordinator: UIViewControllerTransitionCoordinator) {
        ...
        coordinator.animate(alongsideTransition: nil, completion: { (context: UIViewControllerTransitionCoordinatorContext!) -> Void in
            ...
            if self.rightClosePanGesture != nil && self.rightClosePanGesture != nil {
                self.removeRightGestures()
                self.addRightGestures()
            }
        })
        ...
        if rightViewController != nil {
            if SlideMenuOptions.panGesturesEnabled {
                if rightPanGesture == nil {
                    rightPanGesture = UIScreenEdgePanGestureRecognizer(target: self, action: #selector(self.handleRightPanGesture(_:)))
            ...
            if SlideMenuOptions.panGesturesEnabled {
                if rightClosePanGesture == nil {
                    rightClosePanGesture = UIPanGestureRecognizer(target: self, action: #selector(self.handleRightClosePanGesture(_:)))
                    rightClosePanGesture!.delegate = self
                    view.addGestureRecognizer(rightClosePanGesture!)
                }
            }
    ...
    open func removeRightGestures() {
        ...
        if rightClosePanGesture != nil {
            view.removeGestureRecognizer(rightClosePanGesture!)
            rightClosePanGesture = nil
        }
    ...
    @objc func handleRightClosePanGesture(_ panGesture: UIPanGestureRecognizer) {
    ...
    open func gestureRecognizer(_ gestureRecognizer: UIGestureRecognizer, shouldReceive touch: UITouch) -> Bool {
        ...
        } else if gestureRecognizer == rightClosePanGesture {
            return slideRightViewForGestureRecognizer(gestureRecognizer, withTouchPoint: point)
